...
import {  jobseekerActive, loginActive } from "@/Ruduxtoolkit/registerSlice"
...
const Jobseekeraccount = () => {
  ...
  return (
    <div className="forgotpassword w-[500px] bg-[#af8dff65] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-50 p-10 rounded-lg backdrop-blur-md">
      <h2 className="text-center font-bold text-white text-3xl mb-5">Create your free Jobseeker Account</h2>
         <GiCrossMark className="text-3xl text-white cursor-pointer hover:text-red-500 absolute right-4 top-4"
          onClick={()=>dispatch(jobseekerActive(false))} 
         />
    <Form {...form}>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Enter your Full Name" {...field} className="placeholder:text-white text-sm p-4" />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Enter your Email" {...field} className="placeholder:text-white text-sm p-4" />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Enter your mobile number" {...field} className="placeholder:text-white text-sm p-4" />
              </FormControl>
      ...
      <div className="btn pt-2 flex gap-1 justify-center items-center">
        ...
        className="text-pink-500 text-lg p-0">Log in
        </Button>
        </div>
        <div className="btn pt-2">
